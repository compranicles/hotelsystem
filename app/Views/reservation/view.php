                    ...
                    <div class="tab-content" id="reserveTab">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <?php if(count($booked)>0):?>
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="normal_table" class="table table-striped table-hover">
                                                <thead>
                                                    <tr>
                        ...
                        <?php if(count($cancelled)>0):?>
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="cancel_table" class="table table-striped table-hover">
                                                <thead>
                                                    <tr>
                        ...
                        <?php if(count($booked)>0):?>
                                <div class="container mt-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="noshow_table" class="table table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>Reservation ID</th>
                                                        <th>Name of Guest</th>
